...
public class Machine : MonoBehaviour {
	...
	public Transform lidOn;
	public Transform lidOff;
	...
	public Vector3 Spawnpoint = new Vector3 (-2.661758f, 0.4212f, -3.5033f);
	public Vector3 secondSpawnPoint = new Vector3 (-2.712f,0.547f,-3.6f);
	...
	public void CombineCrystals()
	{
		...
		if (firstCrystal.GetComponent<Crystal> ().color == Crystal.CrystalColor.Red && combinationMade == false) 
		{
			...
			if (secondCrystal.GetComponent<Crystal> ().color == Crystal.CrystalColor.Blue) 
			{
				...
				GameObject temp = Instantiate (crystalPrefab, Spawnpoint, Quaternion.identity) as GameObject;
	...
	public void SplitCrystals()
	{
		if(firstCrystal != null && secondCrystal == null)
			...
			if (firstCrystal.GetComponent<Crystal> ().color == Crystal.CrystalColor.BlueGreen) 
			{
				...
				GameObject temp = Instantiate (crystalPrefab, Spawnpoint, Quaternion.identity) as GameObject;
				temp.GetComponent<Crystal> ().color = Crystal.CrystalColor.Green;
				GameObject temp2 = Instantiate (crystalPrefab, secondSpawnPoint, Quaternion.identity) as GameObject;
	...
	public IEnumerator SlideLid(float time)
	{
		...
		{
			//close lid
			lid.transform.rotation = Quaternion.Lerp(lidOff.rotation, lidOn.rotation, firstDuration/ time);
		...
		{
			lid.transform.rotation = Quaternion.Lerp(lidOn.rotation, lidOff.rotation, secondDuration/ time);
